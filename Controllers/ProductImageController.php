...
class ProductImageController extends Controller
{
    ...
    {
        return view('admin.product.product-image-list');
    }
    ...
    {
        return view('admin.product.product-image-add');
    }
    ...
    {
        return view('admin.product.product-image-edit', compact('productImage'));
    }
